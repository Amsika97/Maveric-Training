...
public class ExtractFromString {
	public static void main(String[] args) {
        ...
        String inputFile = "C:\\Users\\amritak\\Desktop\\input.txt"; // Path to the input text file

        String outputFile = "C:\\Users\\amritak\\Desktop\\output.txt"; // Path to the output text file
