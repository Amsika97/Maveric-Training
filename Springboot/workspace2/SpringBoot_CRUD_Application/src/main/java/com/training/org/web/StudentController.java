...
public class StudentController {
	...
	public String editStudent(@PathVariable("id") Long studentId, Model model) {
		Optional<Students> studentOptional = repository.findById(studentId);
		Students student = studentOptional.orElse(new Students());
		model.addAttribute("student", student);
		return "editStudent";
	}

	@RequestMapping(value = "save", method = RequestMethod.POST)
	  public String save(@RequestParam(value = "action", required = true) String action, Students student) {
	...
	public @ResponseBody List<Students> getStudents() {
